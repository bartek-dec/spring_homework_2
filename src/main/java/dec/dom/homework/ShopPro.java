...
public class ShopPro {
    ...
    @Autowired
    public ShopPro(ProductFactory productFactory) {
    ...
    public void displayBasket() {
        ...
        System.out.println("Total value of products, including discount, is: " + getTotal().doubleValue());
    ...
    private BigDecimal getTotal() {
        ...
        double reducedTotal = total * (1 - discount);
        return new BigDecimal(reducedTotal).setScale(2, RoundingMode.HALF_UP);
    }
